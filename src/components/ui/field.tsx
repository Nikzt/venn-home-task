...
function FieldGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/field-group relative mb-2 @container/field-group flex w-full flex-col gap-7 data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-4",
        className,
      )}
      {...props}
    />
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn(
        "text-xs absolute -bottom-5 ml-2 font-normal text-destructive",
        className,
      )}
      {...props}
    >
